...
public class RecordAddJpanel extends JPanel{
	...
	public RecordAddJpanel() {
		...
		rnoTextField.setBounds(100, 45, 233, 37);
		add(rnoTextField);
		...
		add(sureButton);
		RecordJpanelListenerController controller_sure = new RecordJpanelListenerController(this,"add");
